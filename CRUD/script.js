...
function editForm(a){
    ...
    document.getElementById("Nit").value = selectRow.cells[1].innerHTML;
    document.getElementById("fecha").value = selectRow.cells[2].innerHTML;
    document.getElementById("direccion").value = selectRow.cells[3].innerHTML;
}
function updateRecord(formData){
    selectRow.cells[0].innerHTML = formData.Name;
    selectRow.cells[1].innerHTML = formData.Nit;
    selectRow.cells[2].innerHTML = formData.fecha;
    selectRow.cells[3].innerHTML = formData.direccion;
    employees.splice(selectRow.rowIndex-1,1,{Name:formData.Name,Nit:formData.Nit,fecha:formData.fecha,direccion:formData.direccion});
    localStorage.setItem("employees",JSON.stringify(employees));
}
function validate(){
    isValid = true;
